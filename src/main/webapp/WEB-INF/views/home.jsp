...
<body>
	<div class="container" style="padding: 0; position: relative;">
		...
		<div class="main" id="section1">
			<c:if test="${noFlights!=null}">
				<div class="alert alert-danger text-center" role="alert">${noFlights}</div>
			</c:if>
			...
			<div
				...
				<div
					...
					<form class="col-12" action="/available/flights" method="post">
				...
				<div class="col-sm-12 col-md-6 col-lg-3 my-5">
					<div class="card border-0">
						<div class="card-body text-center">
							...
							<address>PES University Electronic City, Bengaluru.</address>
						</div>
					</div>
				</div>
				<div class="col-sm-12 col-md-6 col-lg-3 my-5">
