		...
		<div class="row">
			<div class="col-md-12  mt-4">
				<div class="page-header text-center" style="height: 50px;">
					<h3 class="text-white">Welcome to Airline Reservation System</h3>
				</div>
			</div>
		</div>
			...
			<div class="col-md-6">
				<div class="carousel slide" id="carousel-281405">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" alt="Carousel Bootstrap First"
								src="/images/airline1.jpg" />
							<div class="carousel-caption">
								<h4>Online Booking</h4>
								<p>Welcome! Visiting your favourite
									holiday destination just got smoother by booking your
									tickets easily.</p>
							</div>
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" alt="Carousel Bootstrap Second"
								src="/images/airline2.jpg" />
							<div class="carousel-caption">
