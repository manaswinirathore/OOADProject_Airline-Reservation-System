			...
			<c:forEach items="${ listOfTickets}" var="ticket" varStatus="loop">
				...
				<div class=" card col-12 col-md-7 mt-2">
					<h6 class="card-title mt-2">
						${ticket.getFlightId().getSource()}-
						${ticket.getFlightId().getDestination()}<span class="float-right">${ticket.getFlightId().getFlightNo()}</span>
					</h6>
					...
					<div
						...
						<div class="p-2 bd-highlight">
							<p>Date</p>
							<p>${ticket.getFlightId().getDate()}</p>
						...
						<div class="p-2 bd-highlight">
							<p>Departure time</p>
							<p>${ticket.getFlightId().getDepatureTime()}</p>
