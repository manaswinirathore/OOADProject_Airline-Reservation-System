					...
					<form class="col-12"
						...
						<div class="form-group">
							<label for="formGroupExampleInput2">Seat</label> <select
								...
								<option value="Economy">Economy - Rs.1500</option>
								<option value="Business">Business - Rs.3800</option>
								<option value="FirstClass">FirstClass - Rs.6000</option>
							</select>
						</div>
						<div class="form-group">
				...
				<div id="PassengerDiv">
							...
							<div class="card-body">
								<div class="d-flex flex-row bd-highlight justify-content-around">
									...
									<c:choose>
										...
										<c:when test="${passenger.getSeatPreference() eq 'Economy'}">
											<div class="p-2 bd-highlight text-success font-weight-bold">Rs.1500</div>
										</c:when>

										<c:when test="${passenger.getSeatPreference() eq 'Business'}">
											<div class="p-2 bd-highlight text-success font-weight-bold">Rs.3800</div>
										</c:when>

										<c:otherwise>
											<div class="p-2 bd-highlight text-success font-weight-bold">Rs.6000</div>
										</c:otherwise>
									</c:choose>

									<div class="p-2 bd-highlight">
										<a
											href="/book/${selectedFlight.getFlightNo()}/removepassenger/${loop.index}"><em
					...
					<c:if test="${listOfPassenger.size()>0 }">
						...
						<div class="text-center">
							<a class="btn mt-3 btn-success"
								href="/book/${selectedFlight.getFlightNo()}/payment">Procced
								To Payment</a>
						</div>
					</c:if>
				</div>
