...
<body>
	<div class="container" style="padding: 0; position: relative;">
		...
		<form action="/addflight" style="padding: 20px;" method="post">
			<div class="row justify-content-md-center mt-5">
				...
				<div class="col-12 col-sm-4">
					<div class="form-group">
						<label for="formGroupExampleInput0">flight No</label> <input
							...
							placeholder="flight No" name="flightNo" />
					</div>
					<div class="form-group">
						<label for="formGroupExampleInput1">flight Name</label> <input
							type="text" class="form-control" id="formGroupExampleInput1"
							placeholder="flight Name" name="flightName" />
					</div>
					<div class="form-group">
						<label for="formGroupExampleInput2">Economy Seats</label> <input
							type="text" class="form-control" id="formGroupExampleInput2"
							placeholder="Enter seats available" name="economy" />
					</div>
					<div class="form-group">
						<label for="formGroupExampleInput3">Business Seats</label> <input
							type="text" class="form-control" id="formGroupExampleInput3"
							placeholder="Enter seats available" name="business" />
					</div>
					<div class="form-group">
						<label for="formGroupExampleInput4">First Class Seats</label> <input
							type="text" class="form-control" id="formGroupExampleInput4"
							placeholder="Enter seats available" name="firstclass" />
					</div>
				</div>
				...
				<div class="col-12 col-sm-4">
					...
					<div class="form-group">
						<label for="formGroupExampleInput8">Departure Time</label> <input
