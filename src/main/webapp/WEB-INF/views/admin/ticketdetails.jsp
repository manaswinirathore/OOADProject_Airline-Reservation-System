	...
	<div class="container" style="padding: 0;">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						...
						aria-expanded="false"> Airline Manager </a>
		...
		<div class="row justify-content-center">
				...
				<form class="" action="/getfulldetails" method="get">
					<div class="form-row  justify-content-center">
						<div class="col-sm-5 my-1">
							<label class="sr-only" for="inlineFormInputGroupUsername">flightName</label>
							<div class="input-group">
								<input type="text" class="form-control"
									id="inlineFormInputGroupUsername" placeholder="flightName"
									name="flightName">
							</div>
						</div>
			...
			<div class="col-md-10 mt-3">
				<c:if test="${not empty noflightFound}">
					<div class="alert alert-danger text-center" role="alert">${noflightFound}</div>
				</c:if>
