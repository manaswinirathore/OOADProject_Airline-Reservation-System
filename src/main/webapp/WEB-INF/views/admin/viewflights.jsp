			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row text-center justify-content-center">
						<div class="col-sm-5 ">
							<h5>
								<strong>view available flights</strong>
							</h5>
						</div>
					</div>
				</div>
				<table class="table table-striped table-hover" aria-describedby="flights">
					<thead class="">
						<tr>
							<th scope="row">flight No</th>
							<th scope="row">flight Name</th>
							<th scope="row">Economy seats</th>
							<th scope="row">Business seats</th>
							<th scope="row">First Class seats</th>
					...
					<tbody>
						...
						<c:if test="${listOfFlights.size() <= 0}">
							<p class="text-danger text-center">flights not found</p>
						</c:if>
						...
						<c:forEach var="flight" items="${listOfFlights}">
							<tr>
								...
								<td><a
									href="/getfulldetails?flightName=${flight.getFlightName()}">${flight.getFlightName()}</a></td>
								<td>${flight.getEconomy()}</td>
								<td>${flight.getBusiness()}</td>
								...
								<td><a href="/updateFlightModal/${flight.getFlightNo()}"><em
										class="bi text-info bi-pencil-square"></em></a> &nbsp <a
									href="/deleteflight/${flight.getFlightNo()}"><em
